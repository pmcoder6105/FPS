...
public class PlayerCrouchState : PlayerBaseState
{
    ...
    public override void CheckSwitchState() {
        ...
        if (player.CanJump && InputManager.jumping && _ctx.GetComponent<PlayerMovement>().grounded && player.canJumpWhileCrouching && player.ReadyToJump ) SwitchState(_factory.Jump());
