...
namespace cowsins
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            inputActions.GameControls.Jumping.canceled += ctx => jumping = false;
        ...
        private void LateUpdate()
        {
            ...
            if(player.GetComponent<WeaponController>().alternateAiming  && player.GetComponent<WeaponController>().weapon != null)
            {
            ...
            dashing = Input.GetKey(KeyCode.Mouse2); 
#endif
        }
#if ENABLE_INPUT_SYSTEM
