        ...
        if (currentTab >= 0 || currentTab < tabs.Length)
        {
            switch (tabs[currentTab])
            {
                ...
                case "Advanced Movement":
                    ...
                    EditorGUILayout.LabelField("WALLRUN", EditorStyles.toolbarButton);
                    ...
                    if(myScript.canWallRun)
                    {
                        ...
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("wallRunMinimumHeight"));
                    ...
                    EditorGUILayout.LabelField("WALL BOUNCE", EditorStyles.toolbarButton);
                    ...
                    EditorGUILayout.Space(20);
                    EditorGUILayout.LabelField("DASHING", EditorStyles.toolbarButton);
